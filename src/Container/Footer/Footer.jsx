    ...
    <div className="app__footer" id="Contact me">
      <div className="htext">
        <h2 className="head-text">
          I Look <span>Forward To Hear</span>
          <br />
          From You <span>Contact ME</span>
        </h2>
      </div>
      ...
      <div className="alling">
        <div className="summary">
          ...
          <br />
          and interactive web apps with a modern <br />
        ...
        <div id="Contact_me" className="app__footer-cards">
          ...
          {contact.map((each, index) => (
            <div className="app__footer-card ">
              ...
              <a href={each.link} className="p-text">
                {each.name}
              </a>
            </div>
          ))}
      ...
      <div className="line">
        <p>
          {" "}
          <ImLocation /> Portland, Oregon, United States{" "}
        </p>
        <p>
          <TfiEmail /> kidisttesfaye@gmail.com
        </p>
        <p>
          {" "}
          <BiPhone /> +1 (971) 421-2359{" "}
        </p>
        <hr />
      </div>
    </div>
